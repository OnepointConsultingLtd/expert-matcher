...
consultant_details_base_sql = """SELECT * FROM 
(SELECT C.ID, C.GIVEN_NAME, C.SURNAME, C.LINKEDIN_PROFILE_URL, C.EMAIL, C.CV, STRING_AGG(S.SKILL_NAME, '@@') SKILLS, 
C.LINKEDIN_PHOTO_200, C.LINKEDIN_PHOTO_200, C.CV_SUMMARY FROM TB_CONSULTANT C 
